...
#define CONFIG_SERVERIP			192.168.99.198	/* In order to cause an error */
...
#define CONFIG_ROOTPATH                 "/NFSRoot/18.10" /* Default Dir for NFS */
#define CONFIG_ENV_OVERWRITE		/* ethaddr can be reprogrammed */
#define CONFIG_EXTRA_ENV_SETTINGS	"bootcmd=dhcp;run get_images; " \
						"run set_bootargs; " \
						"booti $kernel_addr_r " \
						"$ramdisk_addr_r " \
						"$fdt_addr_r\0" \
					...
					"fdt_name=sam7/fdt.dtb\0"		\
					"netdev=eth1\0"			\
					"emmc=1\0sd=0\0"		\
					"autoload=no\0"			\
					"ethaddr=00:51:82:11:22:70\0"	\
					"eth1addr=00:51:82:11:22:71\0"	\
					"eth2addr=00:51:82:11:22:72\0"	\
					"eth3addr=00:51:82:11:22:73\0"	\
					"eth4addr=00:51:82:11:22:74\0"	\
					"eth5addr=00:51:82:11:22:75\0"	\
					"image_name=sam7/Image\0"		\
...
#define BOOT_FROM_EMMC_COMMAND "mmc dev $emmc; "\
		"ext4load mmc $emmc:1 $kernel_addr_r $image_name; "\
		"ext4load mmc $emmc:1 $fdt_addr_r $fdt_name; "\
		"setenv bootargs \"$console root=/dev/mmcblk\"$emmc\"p1 rw rootwait $cpuidle\"; "\
		"booti $kernel_addr_r - $fdt_addr_r"

#define BOOT_FROM_SD_COMMAND "mmc dev $sd; "\
		"ext4load mmc $sd:1 $kernel_addr_r $image_name; "\
		"ext4load mmc $sd:1 $fdt_addr_r $fdt_name; "\
		"setenv bootargs \"$console root=/dev/mmcblk\"$sd\"p1 rw rootwait $cpuidle\"; "\
		"booti $kernel_addr_r - $fdt_addr_r"

#define BOOT_FROM_USB_COMMAND "usb reset;" \
		"ext4load usb 0:1 $kernel_addr_r $image_name;" \
		"ext4load usb 0:1 $fdt_addr_r $fdt_name; "\
		"setenv bootargs $console root=/dev/sda1 rw rootwait $cpuidle; "\
		"booti $kernel_addr_r - $fdt_addr_r"

#define IMAGE_NAME_USB_SD_EMMC "boot/Image"
#define FDT_NAME_USB_SD_EMMC "boot/fdt.dtb"
