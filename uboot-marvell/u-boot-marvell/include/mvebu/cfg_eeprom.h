...
#define BOARD_SAVE_BOOT_DEVICE_LENGTH 8
...
struct eeprom_struct {
	...
	u32 pattern;
	u32 forceReload;
	char bootdev[BOARD_SAVE_BOOT_DEVICE_LENGTH];
	u16 length;
...
{ MV_CONFIG_BOOTDEV,"BootDev",	offset_in_eeprom(bootdev),	   \
					sizeof(board_config_val.bootdev)},	   \
...
#define CFG_DEFAULT_VALUE  {						     \
	...
	0x00000000,	\
	{[0 ... (BOARD_SAVE_BOOT_DEVICE_LENGTH-1)] = 0x00},		\
